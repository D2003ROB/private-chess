...
/** Meridian queen, black. Collar and base seams redrawn as light strokes. */
export function BlackQueen(props: PieceArtProps) {
  return (
    <svg viewBox="0 0 45 45" {...props}>
      ...
      >
        ...
        <g fill="none" stroke="var(--piece-white-fill, #FFFFFF)" strokeWidth={1.1}>
          <path d="M 12.4 18.4 L 32.6 18.4" />
          <path d="M 13.2 21.6 L 31.8 21.6" />
