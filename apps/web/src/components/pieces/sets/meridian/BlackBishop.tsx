...
/** Meridian bishop, black. Slit and collar seams redrawn as light strokes. */
export function BlackBishop(props: PieceArtProps) {
  return (
    <svg viewBox="0 0 45 45" {...props}>
      ...
      >
        ...
        <g fill="none" stroke="var(--piece-white-fill, #FFFFFF)" strokeWidth={1.1}>
          <path d="M 20 13.8 L 25 18.8" />
          <path d="M 16.8 22 L 28.2 22" />
          <path d="M 16.6 24.6 L 28.4 24.6" />
          <path d="M 15.2 33 L 29.8 33" />
        </g>
      </g>
    </svg>
  );
