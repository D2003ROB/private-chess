...
/** Meridian king, black. Crown and base seams redrawn as light strokes. */
export function BlackKing(props: PieceArtProps) {
  return (
    <svg viewBox="0 0 45 45" {...props}>
      ...
      >
        ...
        <g fill="none" stroke="var(--piece-white-fill, #FFFFFF)" strokeWidth={1.1}>
          <path d="M 21.6 7 L 23.4 7" />
          <path d="M 16.4 16.4 L 28.6 16.4" />
          <path d="M 15.6 19.8 L 29.4 19.8" />
          <path d="M 11.6 33 L 33.4 33" />
        </g>
      </g>
    </svg>
  );
